...
ActiveRecord::Schema.define(version: 20191019204134) do
  ...
  create_table "administrative_processes", force: :cascade do |t|
    ...
    t.integer  "client_id"
    t.index ["client_id"], name: "index_administrative_processes_on_client_id", using: :btree
  end
  ...
  create_table "labor_processes", force: :cascade do |t|
    ...
    t.datetime "updated_at",        null: false
    t.integer  "client_id"
    t.index ["client_id"], name: "index_labor_processes_on_client_id", using: :btree
  end
